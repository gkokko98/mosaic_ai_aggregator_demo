...
export function CategoryBadge({ category }: { category: CategoryId }) {
  ...
  return (
    <span className="inline-flex items-center rounded-full border border-[#069fbd] bg-[rgba(6,159,189,0.6)] px-3 py-1 text-[11px] font-semibold uppercase text-white shadow-[0_0_10px_3px_rgba(15,16,21,0.6)] backdrop-blur-[4px]">
      {label}
    </span>
  );
}
